...
(201754, 'Garlic', '60 per kg.                                                                  ', '', 82, 0, 60, 38, 'uploaded_photos/2.jpg', 'Available', '', '', 'Active'),
...
--
ALTER TABLE `tblsummary`
  MODIFY `SUMMARYID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
