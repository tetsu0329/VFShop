...
<link href="<?php echo web_root; ?>admin/css/ekko-lightbox.css" rel="stylesheet">
  ...
  <?php
    ...
    $query = "SELECT * FROM tblinquiry WHERE INQSTATUS = 'NEW'";
    $mydb->setQuery($query);
    $cur = $mydb->executeQuery();
    $rowscount = $mydb->num_rows($cur);
    $res = isset($rowscount)? $rowscount : 0;
    ...
    if($res>0){
    $inquiry = '<span style="color:red;">('.$res.')</span>';
    }else{
        $inquiry = '<span> ('.$res.')</span>';
    }
?>
        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >EDUARD AND EDLEEN SHOP</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>admin/dashboard/"><i class="fa fa-tachometer fa-fw"></i>  Dashboard </a>
  ...
  format: 'mm/dd/yyyy',
    ...
    forceParse: 0,
     changeMonth: true,
      ...
      <footer><p  style="text-align: center;font-weight: bold;"> EDUARD AND EDLEEN - FRUITS AND VEGETABLE SHOP </p></footer>
</html>